...
# ./src/examples/experiments/batch/linear_gradient_2bits.sh /src/examples/experiments/batch gradientFollower.argos
...
param_dir=$res_dir/"linear_2bits_"$date_time"_"$experiment_length"_seconds"
